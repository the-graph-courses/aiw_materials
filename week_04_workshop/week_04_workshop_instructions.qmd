...
2. **Insert the Bot Code:**
   ...
   - Paste the two script lines you copied from Botpress right before the opening `</body>` tag. This will be near the end of the document.
   ```html
   <script src="https://cdn.botpress.cloud/webchat/v2.4/inject.js"></script>
   <script src="https://files.bpcontent.cloud/2025/05/27/14/20250527145803-WFVSK7BL.js"></script>
   </body>
