...
Before starting the workshop tasks, please sign up for the following free accounts:

1.  **Ideogram.ai** - Sign up for a free account at **ideogram.ai** (used for AI image generation)

2.  **Canva.com** - Sign up and start a free trial for the pro features at **canva.com**. **Important**: Cancel the trial within your account settings immediately after completing the signup process to avoid charges. (If you have already used up your free trial, please create a new account with a different email address. If this is not possible, please contact an instructor for help.)

3.  **Claude.ai** - Sign up for a free account at **claude.ai** (used for the optional visual abstract challenge)
