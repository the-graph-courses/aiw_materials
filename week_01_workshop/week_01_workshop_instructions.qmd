...
For more details, consult the corresponding video on the website. 
...
- Copy the template text from [thegraphcourses.org/aiw](https://thegraphcourses.org/aiw).
...
## Add your HTML file
- Inside the repo, find the plus icon to **Add file → Create new file**.
...
- In the repo, click **Add file → Upload files** → upload your image.
- Click **Commit changes**.
- Open the uploaded image → right‑click it → **Copy image address**.
- Back in ChatGPT: "Please insert this image as a circular avatar at the top: <paste URL>".
